...
Более жёсткий контроль осуществляется за рубками, ведены ограничения лесопользования, включающие создания заказников и отнесение уникальных объектов природы к охраняемым памятникам.
